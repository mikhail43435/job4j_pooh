 ...
 * Для каждого потребителя в режиме "topic" должна быть уникальная очередь потребления в отличии от режима "queue", где очереди для всех клиентов одна и та же.
